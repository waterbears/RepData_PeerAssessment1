...
Mean is `r activity.daily.mean` and median is `r activity.daily.median`.
...
Most activty time is `r max.time.str`.
...
Number of missing values `r missing.rows`. Imptued daily mean is `r imputed.activity.daily.mean`, and imputed daily median is `r imputed.activity.daily.median`.
